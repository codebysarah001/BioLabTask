USE [master]
GO
/****** Object:  Database [UserRegistrationDB]    Script Date: 9/29/2024 10:25:22 AM ******/
...
GO
ALTER DATABASE [UserRegistrationDB] SET COMPATIBILITY_LEVEL = 160
GO
...
GO
ALTER DATABASE [UserRegistrationDB] SET  ENABLE_BROKER 
GO
...
GO
/****** Object:  Table [dbo].[Users]    Script Date: 9/29/2024 10:25:23 AM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[GetUserByEmailOrUsername]    Script Date: 9/29/2024 10:25:23 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
BEGIN
    ...
    OR (@Username IS NULL OR Username = @Username);
END;
GO
/****** Object:  StoredProcedure [dbo].[InsertUser]    Script Date: 9/29/2024 10:25:23 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END;
GO
/****** Object:  StoredProcedure [dbo].[ValidateUser]    Script Date: 9/29/2024 10:25:23 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
